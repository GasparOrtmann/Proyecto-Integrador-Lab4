		...
		<div class="navbarSuperior">
			...
			<form method="POST"
				...
				<button type="submit" class="btn btn-secondary mr-4"
					name="btnAdmin">
					<i class="fa-solid fa-arrow-right-from-bracket"></i> ADMIN
				</button>
				<%
				}
				%>
				<button type="submit" class="btn btn-secondary ml-4"
					name="btnCerrarSesion" style="margin-left:10px;">
				...
				<div class="navbarLateral">
					<div class="flex-shrink-0 p-3"
						...
						<ul class="list-unstyled ps-0">
							<li
								class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"><a
								href="/TPINT_GRUPO_6_LAB4/ServeletClientes?TraerCuentasUsuario=1"
									...
									<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
										<li><a href="/TPINT_GRUPO_6_LAB4/ServletPrestamos?TraerListadoMisPrestamos=1"
											class="link-dark d-inline-flex text-decoration-none rounded">Mis
												Prestamos</a></li>
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServletPrestamos?TraerCuentasUsuario=1"
							...
							<li class="mb-1">
								...
								<div class="collapse" id="account-collapse" style="">
									<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServletMovimientosLocales?TraerCuentasUsuario=1"
											class="link-dark d-inline-flex text-decoration-none rounded">A
												Cuenta Propia</a></li>
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServletMovimientosExternos?TraerCuentasUsuario=1"
											class="link-dark d-inline-flex text-decoration-none rounded">A
												Otras Cuentas</a></li>
									</ul>
								</div>
