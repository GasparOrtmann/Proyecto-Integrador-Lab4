					...
					<ul class="list-unstyled ps-0">
						...
						<li class="mb-1">
							...
							<div class="collapse" id="account-collapse" style="">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									<li><a href="/TPINT_GRUPO_6_LAB4/ServletMovimientosLocales?TraerCuentasUsuario=1"
										class="link-dark d-inline-flex text-decoration-none rounded">A
											Cuenta Propia</a></li>
									<li><a href="/TPINT_GRUPO_6_LAB4/ServletMovimientosExternos?TraerCuentasUsuario=1" class="link-dark d-inline-flex text-decoration-none rounded">A Otras Cuentas</a></li>
								</ul>
							</div>
						</li>
						<li class="border-top my-3"></li>
