		...
		<div class="col-3">
				...
				<div class="flex-shrink-0 p-3"style="width: 280px; background-color: #B4B1C4; height: 100rem">
					...
					<ul class="list-unstyled ps-0">
							<li class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"><a href="/TPINT_GRUPO_6_LAB4/ServeletClientes?TraerCuentasUsuario=1">INICIO</a></li>
