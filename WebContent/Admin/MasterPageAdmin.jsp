...
<body>
	...
	<div class="container-fluid">
		<div class="navbarSuperior">
			<img src="/TPINT_GRUPO_6_LAB4/Logo_Banco_Credicoop.svg" alt="logo"
				style="height: 90px; width: 200px; margin-left: 35px;" />
			<div>
				<form method="POST"
					action="/TPINT_GRUPO_6_LAB4/ServeletFuncionalidades">

					<button type="submit" class="btn btn-secondary" name="btnHome">
						<i style="margin-right: 5px;" class="fa-solid fa-house"></i>Pagina
						Principal
					</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="col-3">
				<div class="navbarLateral">
					<div class="flex-shrink-0 p-3"
						...
						<br> <a href="/"
							class="d-flex justify-content-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
						...
						<ul class="list-unstyled ps-0">
							<li class="mb-1"><a
								href="/TPINT_GRUPO_6_LAB4/ServeletDashboard?TraerInformacionDashboard=1"
								class="btn btn-toggle d-inline-flex align-items-center rounded border-0">DASHBOARD</a>
							</li>
							...
							<li class="mb-1">
								...
								<div class="collapse" id="orders-collapse" style="">
									<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServletPrestamos?TraerListadoPrestamos=1"
											class="link-dark d-inline-flex text-decoration-none rounded">Prestamos
												Pendientes</a></li>
									</ul>
								</div>
							</li>
							...
							<li class="mb-1">
								<button
									...
									aria-expanded="false">CLIENTES</button>
								<div class="collapse" id="dashboard-collapse">
									<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServeletClientes?TraerListadoClientes=1"
							...
							<li class="mb-1">
								<button
									...
									aria-expanded="false">CUENTAS</button>
								<div class="collapse" id="account-collapse">
									<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
										<li><a
											href="/TPINT_GRUPO_6_LAB4/ServletCuentas?TraerListadoCuentas=1"
											class="link-dark d-inline-flex text-decoration-none rounded">
