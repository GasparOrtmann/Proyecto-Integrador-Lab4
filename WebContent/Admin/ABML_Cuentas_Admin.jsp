...
<body>
	...
	<div style="position: absolute; top: 150px; left: 400px;">
		<form method="post" action="/TPINT_GRUPO_6_LAB4/ServletCuentas"
			...
			<div class="centrar-row">
				...
				<label>Filtrar por usuario:</label> <input type="text"
					name=txtFUsuario /> &nbsp&nbsp Estado: <input type="checkbox"
					name="chkEstado" value="activo" id="ed1">&nbsp&nbsp&nbsp <input
					type="submit" value="Filtrar" name="Filtrar"> <br>
				...
				<tbody>
					...
					<tr>
						<td><input class="border-0 bg-transparent pe-none"
							name="getIdCuenta"
							value="<%=copiaListaPaginada.get(i).getIdCuenta()%>"></td>
						...
						<form method="post"
							action="/TPINT_GRUPO_6_LAB4/ServletCuentas?getIdCuenta=<%=copiaListaPaginada.get(i).getIdCuenta()%>">
							<td><input type="submit" class="btn btn-secondary" name="btnEditar" value="Editar"></td>
							...
							<div class="modal fade" id="exampleModal" tabindex="-1"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">¿Estas seguro de querer borrar
											el registro?</div>
		...
		<form method="post" action="/TPINT_GRUPO_6_LAB4/ServletCuentas"
			...
			<div class="centrar-row">
				<div class="centrar-column container-fields">
					<div>
						<label>Cod Cuenta</label> <input
							class="pe-none border-0 bg-transparent" name="txtCodCuenta"
							type="text" value="<%=cuentaEditar.getIdCuenta()%>">
					</div>
					<div>
						<label>Cod Usuario</label> <input type="text" name="txtCodUsuario"
							value="<%=cuentaEditar.getIdUsuario()%>" required>
					</div>
					<div>
						<label>CBU</label> <input class="pe-none border-0 bg-transparent"
							type="number" name="txtCBU" value="<%=cuentaEditar.getCBU()%>"
							required>
					</div>
					<div>
						<label>Saldo</label> <input type="text" name="txtSaldo"
							value="<%=cuentaEditar.getSaldo()%>" required>
					</div>
					<div>
						<%
						long date = new SimpleDateFormat("dd/MM/yyyy").parse(cuentaEditar.getFechaAlta(), new ParsePosition(0)).getTime();
